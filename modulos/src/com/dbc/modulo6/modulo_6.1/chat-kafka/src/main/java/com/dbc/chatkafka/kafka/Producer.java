...
public class Producer {
    ...
    @Value(value = "${kafka.topic.marcelo}")
    ...
    public void sendMessageGeral(ProdutorDTO produtorDTO) throws JsonProcessingException {
        String payload = objectMapper.writeValueAsString(produtorDTO);
        send(payload, geral);
    }

    public void sendPrivateMessage(ProdutorDTO produtorDTO, String topico) throws JsonProcessingException {
        String payload = objectMapper.writeValueAsString(produtorDTO);
        send(payload, topico);
    }
}